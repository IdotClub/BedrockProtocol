...
class PacketBatch{
	 ...
	 */
	public function getPackets(int $protocolId, PacketPool $packetPool, PacketSerializerContext $decoderContext, int $max) : \Generator{
		$serializer = PacketSerializer::decoder($protocolId, $this->buffer, 0, $decoderContext);
